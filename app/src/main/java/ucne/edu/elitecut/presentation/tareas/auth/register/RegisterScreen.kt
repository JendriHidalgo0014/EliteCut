    ...
    OutlinedTextField(
        ...
        trailingIcon = {
            IconButton(onClick = onToggleVisibility) {
                Icon(visibilityIcon, "Toggle password",
                    tint = MaterialTheme.colorScheme.onSurfaceVariant
                )
            }
        },
        supportingText = { Text("Máximo 30 caracteres (${config.supportingLength}/30)",
        ...
        Column(
                ...
                verticalAlignment = Alignment.CenterVertically)
            {
                IconButton(onClick = onNavigateToLogin) {
                    Icon(Icons.AutoMirrored.Filled.ArrowBack, "Volver al login",
            ...
            OutlinedTextField(
                ...
                leadingIcon = { Icon(Icons.Default.Person, null,
                    tint = MaterialTheme.colorScheme.onSurfaceVariant) },
                supportingText = { Text("Solo letras y espacios (${state.nombre.length}/50)",
                    style = MaterialTheme.typography.labelSmall,
                    color = MaterialTheme.colorScheme.onSurfaceVariant) },
            ...
            OutlinedTextField(
                ...
                leadingIcon = { Icon(Icons.Default.Phone, null,
                    tint = MaterialTheme.colorScheme.onSurfaceVariant) },
                supportingText = { Text("Formato: XXX-XXX-XXXX",
                    style = MaterialTheme.typography.labelSmall,
                    color = MaterialTheme.colorScheme.onSurfaceVariant) },
            ...
            OutlinedTextField(
                ...
                leadingIcon = { Icon(Icons.Default.Email, null,
                    tint = MaterialTheme.colorScheme.onSurfaceVariant) },
                supportingText = { Text("Debe ser una cuenta de Gmail (${state.correo.length}/60)",
                    style = MaterialTheme.typography.labelSmall,
                    color = MaterialTheme.colorScheme.onSurfaceVariant) },
            ...
            PasswordFieldSection(
                config = PasswordFieldConfig(label = "Contraseña",
                    testTag = "input_password",
                    supportingLength = state.password.length),
            ...
            PasswordFieldSection(
                config = PasswordFieldConfig(label = "Confirmar",
                    testTag = "input_confirmar",
                    supportingLength = state.confirmarPassword.length),
                value = state.confirmarPassword,
                isVisible = state.isConfirmarPasswordVisible,
